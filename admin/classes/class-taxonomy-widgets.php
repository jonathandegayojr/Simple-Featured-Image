...
// Creating the widget 
class WPSFI_Taxonomy_Widget extends WP_Widget {
 
	function __construct() {
        parent::__construct(	
            'wpsfi_taxonomy_widget',            
	...
	function wpb_load_widget() {
        register_widget( 'wpsfi_taxonomy_widget' );
    }	
	...
	public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'wpsfi_count' ); ?>"><?php _e( 'Show Post Count', 'wp-simple-featured-image' ); ?></label><br/>
